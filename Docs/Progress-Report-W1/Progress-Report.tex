...
Currently our application is a fully functional prototype.
It properly records air pressure, and displays a graph, along with the requested $\frac{\Delta p}{\Delta t}$ and $\frac{\Delta t}{\Delta p}$.
