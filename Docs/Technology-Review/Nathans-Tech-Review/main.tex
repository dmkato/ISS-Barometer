...
This means that each variable that you want to store using NSUserDefaults must be manipulated to match the class.
This can be done with the use of the classes function, and is only a line of code.
...
\item NSDictionary
\end{itemize}
These types easily cover any that might be necessary on this project, and both NSArrays and NSDictionaries are automatically converted from their Swift equivalents \cite{udefaultBlog}.
