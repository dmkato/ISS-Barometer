...
\begin{titlepage}
    ...
    \begin{singlespace}
        ...
        This is a culmination of all of the documentation required throughout the development of the ISS Barometer project, for CS Capstone 2018.
        Our team has amassed the documentation of the year to provide a comprehensive plan to detail the design and construction of the project.
        The documents included are the Requirements, Design, and Technical Review documents.
        Also included are the poster used at the exposition, the weekly blogs by each of the teammates, and introductions and conclusions of the project.
        Not only does this document serve to fully explain our project to the instructors of the class, but it may serve to instruct others interested in this project.
        Portions of code will be included, as well as an installation guide, to assist those attempting to replicate our project.
        \end{abstract}
    \end{singlespace}
\end{titlepage}
\newpage
...
We added a lock screen button on the top left of the app, this was so that you didn't accidentally press or zoom in when you didn't want to.
...
\ganttgroup{Version 1}{2017-09-20}{2017-12-30} \\ %Will add new line
\ganttbar{Display Readings}{2017-10-30}{2017-11-20} \\
\ganttbar{Basic Plot}{2017-10-20}{2017-11-30} \\
\ganttbar{Settings}{2017-11-20}{2017-11-30} \\
\ganttgroup{Version 2}{2018-01-01}{2018-05-18} \\
\ganttbar{dP/dt Calculation}{2018-01-01}{2018-02-20} \\
\ganttbar{Plot Labels}{2018-01-01}{2018-04-20} \\
\ganttbar{UI Redesign}{2018-05-25}{2018-05-30} \\
\ganttbar{CSV Exporting}{2018-05-01}{2018-05-20} \\
\ganttbar{T-res Calculation}{2018-04-01}{2018-04-30} \\
\ganttbar[
	inline bar/.append style={fill=grey, rounded corners=3pt}
    ]{Final Submission}{2018-05-18}{2018-06-10}
...
\subsection{Introduction}
The ISS Barometer is an iOS application that will serve the crew members of the International Space Station (ISS).
...
Something to note, the choices rely on pre-decidedtechnologies, though these are up for deciding, in my partners' documents.
...
Before storing it separately, this data will be saved with the application, and so there are choices to make regarding storage.
...
This option would allow us to access data, meaning NASA officials in Mission Control would be able to receive and analyze data.
...
As with many applications, ours requires that user preferences be saved with the application, and not required to be reentered every time ISS Barometer launches.
...
Although a relatively cool feature, this doesn't help us in development of a purely iOS application.
...
This would slow down development, and impede the team.
On the flip side, Unity may be installed on Mac, Windows, and Linux, allowing all of the team members equal access \cite{objc1}.
...
This will ensure that our application remains variable, and doesn't cause any drawbacks because the ISS iPads are kept up to date.
...
The color of this application is more of an auxiliary decision, but still requires some thought.
...
This application is not meant to be visually surprising.
...
Also, as our application is being released in two versions, there is time we could use to get feedback from the crew members using the application, and a color scheme would be easily changed.
...
\begin{center}
	...
	Week 7 &  Met with TA talked about how the class is going and how we are communicating with our client. Started tech review. Met with don again talked about technology review. \\ \hline
    ...
    Week 6 & Worked on midterm report and presentation. Talked to don about things he wants changed \\ \hline
...
As of right now to use our application you need to download and have XCode installed. Then all you have to do is download our zip file from our Github page.
Unzip the file and run the build file, this file should set up the project and even start XCode up.
With XCode running, you need to select your device (which can be connected via usb cable) or select the iPad Air 2 simulator.
Once you click the run button, it should then start the program on either you device that's plugged in or start a simulation on the computer.
Minor issues have been found with trying to run the software without a valid developer account, this can be remedied by either purchasing an account, or entering a valid apple id.
This application is restricted to the iPad Air 2, which has a valid barometer, or it can be run on the simulator.
It should be noted that the simulator only displays random data, as there is no ability to feed in real barometer readings.
XCode and other development tools can only be run on Mac OS.
...
\begin{itemize}
	\item \href{https://developer.apple.com/documentation/swift/swift_standard_library}{developer.apple.com}
	\item \href{https://github.com/danielgindi/Charts/issues}{Charts API}
	\item \href{https://developer.apple.com/documentation/coremotion/cmaltimeter}{Barometer Implementation}
\end{itemize}

We used developer.apple.com to download XCode from that and learned the basics of how to use it.
...
Learning more about \LaTeX, and with help from my teammates, introduced me to Atom and Markdown, both of which I am more comfortable with now.
...
If I did it again I would maybe spend more effort making sure we were on the right track in the beginning.
Maybe if we had a mockup, or something, than we could have had a better idea of our UI.
Other than that change, it was a truly great experience, and I learned a lot in the process of producing a useful and impressive product.

\subsection{Cade's Conclusions and Reflections}
I learned how to use swift coding language. This also taught me how to use XCode as it works well with swift. I learned how to use and navigate through UI view controllers. I learned how to send variables from one view controller to another. I learned how view controllers use or interact with global variables, there can be a global variable for all view controllers or just certain ones. Learned how to use stacks and then even more in depth use views to center objects in view controllers, this helped with organization and adding axis to the the graph. Learned how to lock and orient the screen, this was a problem that took a lot of time to figure out as there wasn't very good documentation on it. The answer was barely longer then a line of code.
